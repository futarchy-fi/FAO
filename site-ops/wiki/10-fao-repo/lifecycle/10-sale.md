---
canonical: src/InstanceSale.sol@8b0446604eb93a3c1b43d6363e0e78bf97225300::InstanceSale
...
Current source also embeds invariant traceability at the function boundary: `effectiveSupply` cites `INV-SALE-001`, `_finalizeInitialPhaseIfNeeded` cites `INV-SALE-004`, and `ragequit` cites `INV-SALE-002` plus `INV-SALE-003`. `src/InstanceSale.sol@8b0446604eb93a3c1b43d6363e0e78bf97225300::@custom:spec INV-SALE-001`, `src/InstanceSale.sol@8b0446604eb93a3c1b43d6363e0e78bf97225300::@custom:spec INV-SALE-004`, `src/InstanceSale.sol@8b0446604eb93a3c1b43d6363e0e78bf97225300::@custom:spec INV-SALE-002`
...
- If the `@custom:spec` tags are renamed or removed, [Invariants](../invariants.md) must stop treating sale behavior as directly traceable from source NatSpec. `src/InstanceSale.sol@8b0446604eb93a3c1b43d6363e0e78bf97225300::@custom:spec INV-SALE-002`
...
- Source commits read:
  ...
  - 8b0446604eb93a3c1b43d6363e0e78bf97225300
