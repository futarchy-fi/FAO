---
canonical: src/FAOTwapResolver.sol@8b0446604eb93a3c1b43d6363e0e78bf97225300::FAOTwapResolver
...
Current source tags the two resolver boundaries directly: `bindProposal` carries `INV-TWAP-001` for anchor/window fixity, and `resolve` carries `INV-TWAP-002` for resolution determinism. `src/FAOTwapResolver.sol@8b0446604eb93a3c1b43d6363e0e78bf97225300::@custom:spec INV-TWAP-001`, `src/FAOTwapResolver.sol@8b0446604eb93a3c1b43d6363e0e78bf97225300::@custom:spec INV-TWAP-002`
...
- If the resolver drops or renames the `@custom:spec` tags, [Invariants](../invariants.md) must stop using resolver NatSpec as traceability evidence. `src/FAOTwapResolver.sol@8b0446604eb93a3c1b43d6363e0e78bf97225300::@custom:spec INV-TWAP-002`
