/**
 * F2-buy-via-sale scaffold — see audit/rubrics/topic-2-interface-testing.md.
 *
 * Buy tokens from an active instance sale. Persona: new buyer with 0.01 ETH on Sepolia. Asserts sale.totalAmountRaised + buyer token balance increase.
 *
...
test.fixme('F2-buy-via-sale happy path', async ({ page }) => {
  await page.goto('/');
