/**
 * F6-create-proposal scaffold — see audit/rubrics/topic-2-interface-testing.md.
 *
 * Submit a candidate proposal via FAOFutarchyFactory.createProposal. Persona: instance creator. Asserts factory.marketsCount incremented.
 *
...
test.fixme('F6-create-proposal happy path', async ({ page }) => {
  await page.goto('/');
