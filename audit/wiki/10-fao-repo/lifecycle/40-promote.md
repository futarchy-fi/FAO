---
canonical: src/FAOOfficialProposalOrchestrator.sol@15279877e01f6dea50b96bf056302060e3ab6214
...
- If `setAdapter` becomes one-shot or permissionless, the adapter section must be rebuilt from code rather than the current admin setter. `src/FAOOfficialProposalOrchestrator.sol:108-113`
