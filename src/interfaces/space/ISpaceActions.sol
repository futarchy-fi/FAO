...
interface ISpaceActions {
    ...
    ///          votingDelay  The delay between the creation of a proposal and the start of the
    /// voting period. minVotingDuration  The minimum duration of the voting period.
    ...
    ///          proposalValidationStrategyMetadataURI  The metadata URI for
    /// `proposalValidationStrategy`. daoURI  The ERC4824 DAO URI for the space.
