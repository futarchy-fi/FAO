...
interface ISpaceState {
    ...
    /// @return finalizationStatus The finalization status of the proposal. See
    /// `FinalizationStatus`. @return executionPayloadHash The keccak256 hash of the execution
    /// payload.
    /// @return activeVotingStrategies The bit array of the active voting strategies for the
    /// proposal.
