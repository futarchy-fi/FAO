...
interface ISpaceOwnerActions {
    ...
    ///     proposalValidationStrategyMetadataURI The new metadata URI for the proposal validation
    /// strategy. authenticatorsToAdd The authenticators to add. Set to an empty array to ignore.
    ...
    ///     votignStrategiesToRemove The indices of voting strategies to remove. Set to empty array
    /// to ignore.
