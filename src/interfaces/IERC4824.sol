...
interface IERC4824 {
    ...
    ///         should point to a JSON file that conforms to the "EIP-4824 Proposals JSON-LD
    /// Schema". The activityLogURI should point to a JSON file that conforms to the "EIP-4824
    /// Activity
    ///         Log JSON-LD Schema". The governanceURI should point to a flatfile, normatively a .md
    /// file. Each of the JSON files named above can be statically hosted or dynamically-generated.
